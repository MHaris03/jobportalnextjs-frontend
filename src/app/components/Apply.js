      ...
      <div className="relative bg-white p-6 rounded-lg w-full max-w-md" ref={contentRef}>
        ...
        {isLoading ? (
          <div className="flex justify-center items-center">
            <img src="/loader.gif" alt="Loading..." style={{ height: "300px" }} />
          </div>
        ) : (
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="p-2 w-full flex justify-center items-center border border-gray-300 outline-none bg-sky-500 text-white my-2"
            >
              Submit
            </button>
          </form>
