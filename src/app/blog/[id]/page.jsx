...
const BlogDetail = () => {
  ...
  if (error) {
    return <div className="text-center text-red-600 py-20 mt-16 min-h-screen">Error: {error}</div>;
  }

  if (!blogData) {
    return <div className="text-center py-20 mt-16 min-h-screen">No blog data found.</div>;
  }
  ...
  return (
    <HelmetProvider>
      <Helmet>
        ...
        <meta property="og:url" content={`https://www.aidifys.com/blog/${slug}`} />
      </Helmet>

      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-8 mt-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <article className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl max-w-none">
              ...
              <div className="mt-10 text-lg" dangerouslySetInnerHTML={{ __html: blogData?.content }} />
            </article>
          </div>
