...
import { faqs } from "../components/data/Companyinfo";
      ...
      <HelmetProvider>
        <Helmet>
          ...
          <meta name="description"
            content="Find answers to frequently asked questions about Aidifys. Get information on our services,
             policies, and platform usage." />
          <meta property="og:title" content="FAQ's - Aidifys" />
